 ...
 * admin have full controll, full access over system resources
 * @auth   Required (JWT)
 * @prefix api/v1/admin
 * @access Admin Only
 */
...
Route::group(['prefix' => '/admin', 'middleware' => ['auth:api', 'role:admin,api']], function () {
     ...
     * @path   GET /api/v1/admin/course-categories
     ...
     * @path   GET /api/v1/admin/course-categories/{courseCategory}
     ...
     * @path   POST /api/v1/admin/course-categories
     ...
     * @path   PUT /api/v1/admin/course-categories/{courseCategory}
     ...
     * @path   DELETE /api/v1/admin/course-categories/{courseCategory}
     ...
     * @path   POST /api/v1/admin/course-categories/{courseCategory}/activate
     ...
     * @path   POST /api/v1/admin/course-categories/{courseCategory}/deactivate
     ...
     * @path   GET /api/v1/admin/enrollments
     ...
     * @path   GET /api/v1/admin/enrollments/{enrollment}
     ...
     * @path   POST /api/v1/admin/enrollments
     ...
     * @path   PUT /api/v1/admin/enrollments/{enrollment}
     ...
     * @path   PUT /api/v1/admin/enrollments/{enrollment}/status
     ...
     * @path   GET /api/v1/admin/enrollments/{enrollment}/progress
     ...
     * @path   GET /api/v1/admin/courses/enrollable/list
     ...
     * @path   GET /api/v1/admin/courses/instructor/{instructorId}
     ...
     * @path   GET /api/v1/admin/courses/{course}
     ...
     * @path   POST /api/v1/admin/courses
    ...
    /**
     * @name   Update Course
     * @path   PUT /api/v1/admin/courses/{course}
    ...
    /**
     * @name   Delete Course
     * @path   DELETE /api/v1/admin/courses/{course}
    ...
    /**
     * @name   Publish Course
     * @path   POST /api/v1/admin/courses/{course}/publish
     ...
     * @path   POST /api/v1/admin/courses/{course}/unpublish
     ...
     * @path   PUT /api/v1/admin/courses/{course}/status
     ...
     * @path   GET /api/v1/admin/courses/{course}/publishability
     ...
     * @path   GET /api/v1/admin/courses/{course}/duration
     ...
     * @path   POST /api/v1/admin/courses/{course}/instructors/assign
     ...
     * @path   DELETE /api/v1/admin/courses/{course}/instructors/remove
     ...
     * @path   PUT /api/v1/admin/courses/{course}/instructors/primary
     ...
     * @path   DELETE /api/v1/admin/courses/{course}/instructors/primary
     ...
     * @path   GET /api/v1/admin/courses/{course}/instructors
     ...
     * @path   GET /api/v1/admin/units/course/{course}
     ...
     * @path   POST /api/v1/admin/units/course/{course}/reorder
     ...
     * @path   GET /api/v1/admin/units/course/{course}/count
     ...
     * @path   GET /api/v1/admin/units/{unit}
    ...
    /**
     * @name   Update Unit
     * @path   PUT /api/v1/admin/units/{unit}
    ...
    /**
     * @name   Delete Unit
     * @path   DELETE /api/v1/admin/units/{unit}
     ...
     * @path   GET /api/v1/admin/units/{unit}/duration
     ...
     * @path   GET /api/v1/admin/units/{unit}/can-delete
     ...
     * @path   PUT /api/v1/admin/units/{unit}/position
     ...
     * @path   GET /api/v1/admin/courses/{course}/units
     ...
     * @path   GET /api/v1/admin/courses/{course}/units/{unit}
     ...
     * @path   POST /api/v1/admin/courses/{course}/units
     ...
     * @path   PUT /api/v1/admin/courses/{course}/units/{unit}
     ...
     * @path   DELETE /api/v1/admin/courses/{course}/units/{unit}
     ...
     * @path   GET /api/v1/admin/lessons/unit/{unit}
     ...
     * @path   POST /api/v1/admin/lessons/unit/{unit}/reorder
     ...
     * @path   GET /api/v1/admin/lessons/unit/{unit}/count
     ...
     * @path   GET /api/v1/admin/lessons/{lesson}
    ...
    /**
     * @name   Create Lesson
     * @path   POST /api/v1/admin/lessons
    ...
    /**
     * @name   Update Lesson
     * @path   PUT /api/v1/admin/lessons/{lesson}
    ...
    /**
     * @name   Delete Lesson
     * @path   DELETE /api/v1/admin/lessons/{lesson}
     ...
     * @path   GET /api/v1/admin/lessons/{lesson}/duration
     ...
     * @path   PUT /api/v1/admin/lessons/{lesson}/position
     ...
     * @path   GET /api/v1/admin/courses/{course}/units/{unit}/lessons
     ...
     * @path   GET /api/v1/admin/courses/{course}/units/{unit}/lessons/{lesson}
     ...
     * @path   POST /api/v1/admin/courses/{course}/units/{unit}/lessons
     ...
     * @path   PUT /api/v1/admin/courses/{course}/units/{unit}/lessons/{lesson}
     ...
     * @path   DELETE /api/v1/admin/courses/{course}/units/{unit}/lessons/{lesson}
     ...
     * @path   GET /api/v1/admin/users/{user}
     ...
     * @path   PUT /api/v1/admin/users/{user}
     ...
     * @path   DELETE /api/v1/admin/users/{user}
   ...
   /**
     ...
     * @path   GET /api/v1/admin/instructors
   ...
   /**
     ...
     * @path   POST /api/v1/admin/instructors
   ...
   /**
     ...
     * @path   GET /api/v1/admin/instructors/{instructor}
   ...
   /**
     ...
     * @path   GET /api/v1/admin/students
   ...
   /**
     ...
     * @path   PUT /api/v1/admin/instructors/{instructor}
   ...
   Route::put('/instructors/{instructor}',[InstructorController::class,'update']);
    ...
    /**
      ...
      * @path   DELETE /api/v1/admin/instructors/{instructor}
    ...
    /**
      ...
      * @path   GET /api/v1/admin/students/{student}
   ...
   Route::get('/students',[StudentController::class,'index']);
    ...
    /**
      ...
      * @path   GET /api/v1/admin/students/{student}/with-courses
   ...
   Route::get('/students/{student}/with-courses', [StudentController::class, 'showWithCourses']);
    ...
    /**
      ...
      * @path   GET /api/v1/admin/students/{student}/with-quizzes
   ...
   /**
     ...
     * @path   POST /api/v1/admin/students
    ...
    */
     ...
     * @path   PUT /api/v1/admin/students/{student}
     ...
     * @path   DELETE /api/v1/admin/students/{student}
   ...
   /**
     ...
     * @path   GET /api/v1/admin/auditors
   ...
   /**
     * @name   Assign Auditor
     * @path   POST /api/v1/admin/auditors
   ...
   /**
     ...
     * @path   GET /api/v1/admin/auditors/{auditor}
   ...
   /**
     ...
     * @path   PUT /api/v1/admin/auditors/{auditor}
   ...
   /**
     ...
     * @path   DELETE /api/v1/admin/auditors/{auditor}
